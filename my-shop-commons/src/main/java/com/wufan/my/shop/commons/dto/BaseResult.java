package com.wufan.my.shop.commons.dto;

import java.io.Serializable;

/**
 * @author ：WuFan
 * @date ：Created in 2019/11/23 0023 16:02
 * @description：自定义返回结果
 * @modified By：
 * @version: $
 */
public class BaseResult implements Serializable {
    ...
    public  static BaseResult success(){
        return BaseResult.createResult(STATUS_SUCCESS,"请求成功",null);
    }
    ...
    public static BaseResult fail(){
        return BaseResult.createResult(STATUS_FAIL,"请求失败",null);
    }
