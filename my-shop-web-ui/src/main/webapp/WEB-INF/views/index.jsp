...
<div id="header">
    <div class="header-box">
        <h3 class="huany">罗霄山农产品直销商城欢迎您的到来！</h3>
        <ul class="header-left">
            <li class="bj">
                <a class="dib" href="#">炎陵县</a>
                <i class="ci-leftll">
                    <s class="jt">◇</s>
                </i>
                <div class="bj-1">
        ...
        <ul class="header-right">
            <c:choose>
                <c:when test="${tbUser != null}">
                    <li class="denglu">Hi~<a>${tbUser.username}</a> <a>欢迎回来</a> <a href="/loginout">[注销]</a></li>
                </c:when>
                <c:otherwise>
            ...
            <li class="shu"></li>
            <li class="shouji bj">
                <a class="ing_ps ps3" href="#">手机罗霄山农产品直销商城</a>
                <i class="ci-right ">
                    <s class="jt">◇</s>
                </i>
                <div class="shouji1">
                    ...
                    <div class="yi">
                        ...
                        <div class="er">
                            <p>罗霄山直销商城微信公众号</p>
                            <p class="red">关注罗霄山直销商城公众号的积分，换大礼</p>
                        </div>
                    </div>
                </div>
            </li>
